...
public final class CreateCrushingRecipeGen extends CrushingRecipeGen {
	...
	IRON_NAUTILUS_ARMOR = create(() -> Items.IRON_NAUTILUS_ARMOR, b -> b.duration(200)
		.output(Items.IRON_INGOT, 2)
	...
	GOLDEN_NAUTILUS_ARMOR = create(() -> Items.GOLDEN_NAUTILUS_ARMOR, b -> b.duration(200)
		.output(Items.GOLD_INGOT, 2)
		.output(.5f, Items.NAUTILUS_SHELL, 2)
		.output(.5f, Items.GOLD_INGOT, 2)
		.output(.25f, Items.STRING, 2)
		.output(.25f, Items.GOLD_NUGGET, 8)),
	...
	NETHERITE_HORSE_ARMOR = create(() -> Items.NETHERITE_HORSE_ARMOR, b -> b.duration(200)
		.output(Items.DIAMOND, 1)
		.output(.5f, Items.LEATHER, 2)
		.output(.1f, Items.DIAMOND, 3)
		.output(.25f, Items.STRING, 2)
		.output(.025f, Items.NETHERITE_INGOT)
		.output(.08f, Items.NETHERITE_SCRAP, 4)),

	DIAMOND_NAUTILUS_ARMOR = create(() -> Items.DIAMOND_NAUTILUS_ARMOR, b -> b.duration(200)
		.output(Items.DIAMOND, 1)
		.output(.5f, Items.NAUTILUS_SHELL, 2)
		.output(.1f, Items.DIAMOND, 3)
		.output(.25f, Items.STRING, 2)),

	NETHERITE_NAUTILUS_ARMOR = create(() -> Items.NETHERITE_NAUTILUS_ARMOR, b -> b.duration(200)
		.output(Items.DIAMOND, 1)
		.output(.5f, Items.NAUTILUS_SHELL, 2)
		.output(.1f, Items.DIAMOND, 3)
		.output(.25f, Items.STRING, 2)
	...
	public CreateCrushingRecipeGen(HolderLookup.Provider registries, net.minecraft.data.recipes.RecipeOutput output) {
