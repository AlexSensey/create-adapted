...
public final class CreateHauntingRecipeGen extends HauntingRecipeGen {
	...
	SOUL_SAND = convert(() -> tag(ItemTags.SAND), () -> Blocks.SOUL_SAND),
	SOUL_DIRT = convert(() -> tag(ItemTags.DIRT), () -> Blocks.SOUL_SOIL),
		BLACK_STONE = convert(() -> tag(Tags.Items.COBBLESTONES), () -> Blocks.BLACKSTONE),
	...
	public CreateHauntingRecipeGen(HolderLookup.Provider registries, net.minecraft.data.recipes.RecipeOutput output) {
