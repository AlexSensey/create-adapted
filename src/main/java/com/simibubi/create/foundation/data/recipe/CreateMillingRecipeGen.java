...
public final class CreateMillingRecipeGen extends MillingRecipeGen {
	/** Keeps the old recipe table readable while mapping 26.2 color collections. */
	private static final class Items {
		static final Item BEETROOT = net.minecraft.world.item.Items.BEETROOT;
		static final Item BEETROOT_SEEDS = net.minecraft.world.item.Items.BEETROOT_SEEDS;
		static final Item BLACK_DYE = dye(DyeColor.BLACK);
		static final Item BLUE_DYE = dye(DyeColor.BLUE);
		static final Item BONE = net.minecraft.world.item.Items.BONE;
		static final Item BONE_MEAL = net.minecraft.world.item.Items.BONE_MEAL;
		static final Item BROWN_DYE = dye(DyeColor.BROWN);
		static final Item CALCITE = net.minecraft.world.item.Items.CALCITE;
		static final Item CHARCOAL = net.minecraft.world.item.Items.CHARCOAL;
		static final Item CLAY_BALL = net.minecraft.world.item.Items.CLAY_BALL;
		static final Item COAL = net.minecraft.world.item.Items.COAL;
		static final Item COCOA_BEANS = net.minecraft.world.item.Items.COCOA_BEANS;
		static final Item CYAN_DYE = dye(DyeColor.CYAN);
		static final Item DRIPSTONE_BLOCK = net.minecraft.world.item.Items.DRIPSTONE_BLOCK;
		static final Item FLINT = net.minecraft.world.item.Items.FLINT;
		static final Item GRAY_DYE = dye(DyeColor.GRAY);
		static final Item GREEN_DYE = dye(DyeColor.GREEN);
		static final Item INK_SAC = net.minecraft.world.item.Items.INK_SAC;
		static final Item LAPIS_LAZULI = net.minecraft.world.item.Items.LAPIS_LAZULI;
		static final Item LEATHER = net.minecraft.world.item.Items.LEATHER;
		static final Item LIGHT_BLUE_DYE = dye(DyeColor.LIGHT_BLUE);
		static final Item LIGHT_GRAY_DYE = dye(DyeColor.LIGHT_GRAY);
		static final Item LIME_DYE = dye(DyeColor.LIME);
		static final Item MAGENTA_DYE = dye(DyeColor.MAGENTA);
		static final Item ORANGE_DYE = dye(DyeColor.ORANGE);
		static final Item PINK_DYE = dye(DyeColor.PINK);
		static final Item PURPLE_DYE = dye(DyeColor.PURPLE);
		static final Item RED_DYE = dye(DyeColor.RED);
		static final Item SADDLE = net.minecraft.world.item.Items.SADDLE;
		static final Item STRING = net.minecraft.world.item.Items.STRING;
		static final Item SUGAR = net.minecraft.world.item.Items.SUGAR;
		static final Item SUGAR_CANE = net.minecraft.world.item.Items.SUGAR_CANE;
		static final Item WHEAT = net.minecraft.world.item.Items.WHEAT;
		static final Item WHEAT_SEEDS = net.minecraft.world.item.Items.WHEAT_SEEDS;
		static final Item WHITE_DYE = dye(DyeColor.WHITE);
		static final Item YELLOW_DYE = dye(DyeColor.YELLOW);
	...
	public CreateMillingRecipeGen(HolderLookup.Provider registries, net.minecraft.data.recipes.RecipeOutput output) {
