...
public class AllEntityTypes {
	...
	private static <T extends Entity> CreateEntityBuilder<T, ?> contraption(String name, EntityFactory<T> factory,
																			NonNullSupplier<NonNullFunction<EntityRendererProvider.Context, EntityRenderer<? super T, ? extends EntityRenderState>>> renderer, int range,
	...
	private static <T extends Entity> CreateEntityBuilder<T, ?> register(String name, EntityFactory<T> factory,
																		 NonNullSupplier<NonNullFunction<EntityRendererProvider.Context, EntityRenderer<? super T, ? extends EntityRenderState>>> renderer,
		...
		return (CreateEntityBuilder<T, ?>) Create.registrate()
			...
			.renderer((NonNullSupplier) renderer);
	}
