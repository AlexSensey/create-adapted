...
public class SequencedAssemblyRecipeBuilder {
	...
	public SequencedAssemblyRecipeBuilder(Identifier id) {
		...
		this.recipe = new SequencedAssemblyRecipe(new SequencedAssemblyRecipeSerializer());
	}

	public SequencedAssemblyRecipeBuilder withRegistries(HolderLookup.Provider registries) {
