...
public class CarriageBogey {
	...
	public CompoundTag write(DimensionPalette dimensions) {
		...
		bogeyData.putBoolean(UPSIDE_DOWN_KEY, upsideDown);
		writeIdentifier(bogeyData, BOGEY_STYLE_KEY, getStyle().id);
	...
	public BogeyStyle getStyle() {
		Identifier location = readIdentifier(this.bogeyData, BOGEY_STYLE_KEY, AllBogeyStyles.STANDARD.id);
	...
	private CompoundTag createBogeyData() {
		...
		writeIdentifier(nbt, BOGEY_STYLE_KEY, style.id);
