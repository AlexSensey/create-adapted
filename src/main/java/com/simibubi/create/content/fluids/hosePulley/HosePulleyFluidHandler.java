...
public class HosePulleyFluidHandler implements IFluidHandler {
	...
	public FluidStack getFluidInTank(int tank) {
		if (internalTank.isEmpty() && drainer != null)
	...
	public void setBehaviours(FluidFillingBehaviour filler, FluidDrainingBehaviour drainer) {
		this.filler = filler;
		this.drainer = drainer;
	}

	public boolean isReady() {
		return filler != null && drainer != null;
	}
