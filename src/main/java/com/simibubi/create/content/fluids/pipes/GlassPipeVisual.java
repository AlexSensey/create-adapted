...
public class GlassPipeVisual extends AbstractBlockEntityVisual<StraightPipeBlockEntity> implements SimpleDynamicVisual {
	...
	public void beginFrame(Context ctx) {
		...
		for (Direction side : Iterate.directions) {
			...
			TextureAtlasSprite flowTexture = fluidModel.flowingMaterial().sprite();

			int color = ClientFluidHelper.INSTANCE.getColor((TypedInstance<Fluid>) fluidStack, null, null);
			...
			if (progress != 1) {
				TextureAtlasSprite stillTexture = fluidModel.stillMaterial().sprite();
