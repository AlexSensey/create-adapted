...
public class DeployerScenes {
	...
	public static void filter(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.world().modifyBlockEntityNBT(deployerSelection, teType, nbt -> nbt.put("HeldItem", CreateSceneBuilder.serializeItemStack(scene.world().getHolderLookupProvider(), pot)));
		scene.idle(10);
		...
		scene.world().modifyBlockEntityNBT(deployerSelection, teType,
			nbt -> nbt.put("HeldItem", CreateSceneBuilder.serializeItemStack(scene.world().getHolderLookupProvider(), ItemStack.EMPTY)));
		scene.world().moveDeployer(deployerPos, -1, 25);
		scene.idle(20);
		...
		scene.world().modifyBlockEntityNBT(deployerSelection, teType, nbt -> nbt.put("HeldItem", CreateSceneBuilder.serializeItemStack(scene.world().getHolderLookupProvider(), tulip)));
		scene.idle(10);
		scene.overlay().showText(40)
			.placeNearTarget()
		...
		ElementLink<EntityElement> sheep = scene.world().createEntity(w -> {
			Sheep entity = new Sheep(EntityTypes.SHEEP, w);
		...
		scene.idle(17);
		scene.world().modifyEntity(entity1, Entity::discard);
		scene.world().modifyBlockEntityNBT(deployerSelection, teType, nbt -> nbt.put("HeldItem", CreateSceneBuilder.serializeItemStack(scene.world().getHolderLookupProvider(), shears)));
		scene.idle(10);
	...
	public static void modes(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.world().modifyBlockEntityNBT(deployerSelection, DeployerBlockEntity.class,
			nbt -> nbt.put("HeldItem", CreateSceneBuilder.serializeItemStack(scene.world().getHolderLookupProvider(), tool)));
		scene.idle(45);
