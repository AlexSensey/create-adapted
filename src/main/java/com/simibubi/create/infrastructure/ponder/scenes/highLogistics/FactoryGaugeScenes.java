			...
			.modifyBlockEntityNBT(basin, BasinBlockEntity.class, nbt -> {
				nbt.put("VisualizedItems",
					NBTHelper.writeCompoundList(
						ImmutableList.of(IntAttached.with(1, AllItems.ANDESITE_ALLOY.asStack())), ia -> (CompoundTag) CreateSceneBuilder.serializeItemStack(builder.world().getHolderLookupProvider(), ia.getValue())));
			});
		scene.idle(4);
