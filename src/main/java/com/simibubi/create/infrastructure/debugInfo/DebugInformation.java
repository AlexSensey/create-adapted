...
public class DebugInformation {
	...
	private static final ImmutableMap<String, String> mcSystemInfo = ImmutableMap.<String, String>builder()
		.put("JVM Flags", String.join(" ", java.lang.management.ManagementFactory.getRuntimeMXBean()
			.getInputArguments()))
		.put("Memory", Runtime.getRuntime().maxMemory() + " bytes max")
		.build();
	...
	static {
		DebugInfoSection.builder(Create.NAME)
			...
			.put("Minecraft Version", SharedConstants.getCurrentVersion().toString())
		...
		DebugInfoSection.builder("System Information")
			.put("Operating System", System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") version " + System.getProperty("os.version"))
			.put("Java Version", System.getProperty("java.version") + ", " + System.getProperty("java.vendor"))
