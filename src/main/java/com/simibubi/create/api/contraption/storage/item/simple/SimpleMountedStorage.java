...
public class SimpleMountedStorage extends WrapperMountedItemStorage<ItemStackHandler> {
	...
	public void unmount(Level level, BlockState state, BlockPos pos, @Nullable BlockEntity be) {
		...
		ResourceHandler<ItemResource> capability = level.getCapability(Capabilities.Item.BLOCK, pos, null);
		if (capability == null)
			return;
		validate(new ResourceHandlerItemAdapter(capability)).ifPresent(handler -> {
