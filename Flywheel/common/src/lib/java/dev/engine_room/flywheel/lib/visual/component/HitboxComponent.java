...
public final class HitboxComponent implements EntityComponent {
	...
	public void beginFrame(DynamicVisual.Context context) {
		...
		// Entity hitbox rendering moved into extracted debug render state in 26.2.
		// Flywheel visuals currently leave that optional debug overlay to vanilla.
		var shouldRenderHitBoxes = false;
