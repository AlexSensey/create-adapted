...
public class MinecartElementImpl extends AnimatedSceneElementBase implements MinecartElement {
	...
	public void tick(PonderScene scene) {
		...
		if (entity == null) {
			...
			entity.setId(System.identityHashCode(this));
		}
	...
	protected void renderLast(PonderLevel world, MultiBufferSource buffer, SubmitNodeCollector queue, Camera camera,
		...
		if (entity == null) {
			...
			// 26.2's minecart renderer reads the entity id while extracting its
			// render state. Virtual Ponder entities are never added to a level, so
			// assign them a stable local id just like ParrotElementImpl does.
			entity.setId(System.identityHashCode(this));
		}
